...
PRODUCT_PACKAGES += \
    FrameworksResRhodei \
    LineageSystemUIRhodei \
    SettingsProviderResRhodei \
    SystemUIResRhodei \
    WifiResRhodei
...
# Fingerprint
PRODUCT_PACKAGES += \
    android.hardware.biometrics.fingerprint@2.1-service.rhodei \
...
# Thermal
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/thermal-engine-rhodei.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-rhodei.conf
